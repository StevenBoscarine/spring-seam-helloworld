package com.boscarine.example.spring.autowired;
...
/**
 * This is a simple bean, proving that we can use annotation-based Spring config
 * from Spring 2.x+. Everything in this class can run in any Spring container.
 */
@Component
